...
import no.nav.tms.token.support.idporten.wonderwall.authentication.AuthConfiguration
import no.nav.tms.token.support.idporten.wonderwall.authentication.OauthServerConfigurationMetadata
import no.nav.tms.token.support.idporten.wonderwall.authentication.config.HttpClientBuilder.buildHttpClient
import java.net.URL
